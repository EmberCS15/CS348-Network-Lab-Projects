...
public class Packet {
    ...
    private long pktLength;
    private double generationTime;
    private double terminationTime;

    public Packet(String packetId, String srcId, long pktLength, double generationTime, double terminationTime) {
    ...
    public long getPktLength() {
        return pktLength;
    }

    public void setPktLength(long pktLength) {
        this.pktLength = pktLength;
    }
